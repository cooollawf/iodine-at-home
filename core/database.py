...
class Database:
    ...
    async def create_table(self):
        ...
        await self.close()
    async def create_cluster(self, name: str, id: str, secret: str, bandwidth: int, trust: int = 0, isBanned: bool = False, banreason: str = '', host: str = '', port: int = 80, version: str = '', runtime: str = ''):
        await self.connect()
        await self.conn.execute('''
        ...
        ''', (name, id, secret, bandwidth, trust, isBanned, banreason, host, port, version, runtime))
        await self.conn.commit()
        await self.close()
        return True
    ...
    async def edit_cluster(self, id: str, name: str = None, secret: str = None, bandwidth: int = None, trust: int = None, isBanned: bool = None, ban_reason: str = None, host: str = None, port: int = None, version: str = None, runtime: str = None):
